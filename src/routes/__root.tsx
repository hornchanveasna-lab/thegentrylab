...
function applyCMBrandColor(hex: string) {
  ...
  root.setProperty("--page-wash-dark", `linear-gradient(180deg, color-mix(in srgb, ${hex} 22%, #0a0a0b) 0%, #0a0a0b 45%, color-mix(in srgb, ${hex} 10%, #0a0a0b) 100%)`);
  root.setProperty("--page-wash-light", `linear-gradient(180deg, color-mix(in srgb, ${hex} 18%, #faf7f2) 0%, #faf7f2 45%, color-mix(in srgb, ${hex} 7%, #faf7f2) 100%)`);
}

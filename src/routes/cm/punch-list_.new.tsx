...
import type { TaskPriority } from "@/lib/cm-data";
...
function NewPunchItemPage() {
  ...
  return (
    <NewPunchItemSheet
      ownerId={user.id} projectId={projectId} canApprove={canApprove} defaultPriority={defaultPriority} backTo="/cm/punch-list"
      onCreated={() => {

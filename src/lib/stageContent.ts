...
export const STAGE_CONTENT: StageContent[] = [
  ...
  /* ─── STAGE 05: PERMIT NAVIGATION ──────────────────────────── */
  {
    ...
    processSteps: [
      ...
      },
      {
        ...
        desc: "Issued by MLMUPC (Ministry of Land Management, Urban Planning and Construction) and approved at capital/provincial Governor level. The Construction Law 2019 sets the overall licensing framework (Art. 1, 5, 6, 9); Prakas No. 109 governs technical inspection and certification of the architectural/engineering plans themselves before a permit can issue; Prakas No. 291 (2026) sets the exact step-by-step permit-granting procedure. Official sequence: acknowledgment of a complete dossier (2 working days) → technical inspector + architect completeness/compliance review (20 working days) → if deficient, applicant gets 20 working days to correct → MLMUPC Director-General reviews the full file including inspector reports (20 working days) → Director-General prepares the permit and technical certification within 5 working days of the review report → capital/provincial Governor reviews and approves (15 working days) → permit formally recorded and issued (2 working days) → applicant must collect the issued permit within 1 working day of notification. A clean, complete dossier runs roughly 65 working days end to end; a deficient first submission adds the full 20-day correction cycle on top. Required documents (Art. 4): permit application form (1 original); proof of land ownership or lease agreement (2 copies) — or, for soft-title/unregistered land, a commune/sangkat certificate confirming the applicant's land-use claim; proof of application-fee payment (2 copies); the designer's professional competency licence (2 copies); construction drawings (5 copies); inspection & design certification report (5 copies); drawing-conformity certificate (5 copies). A separate Occupancy Certificate is required before the building may be used.",
        duration: "8–16 weeks", risk: "high",
      },
      {
    ...
    permits: [
      ...
      { name: "Construction Building Permit", authority: "MLMUPC / Capital-Provincial Governor", costMin: 3000, costMax: 25000, weeksMin: 8, weeksMax: 16, notes: "Legal basis: Construction Law 2019 Art. 1/5/6/9; Prakas No. 109 (plan inspection/certification); Prakas No. 291 (2026, permit procedure) • Fee: $3–8/m² of GFA for industrial buildings, set by joint MEF–MLMUPC Prakas • Submit (Art. 4): application form, land title or lease (or commune land-use certificate for soft title), fee receipt, designer's licence, 5 copies of construction drawings, inspection/certification report, drawing-conformity certificate • Procedure: 2-day acknowledgment → 20-day technical review → (20-day correction window if deficient) → 20-day Director-General review → 5-day permit preparation → 15-day Governor approval → 2-day issuance → 1-day collection • Tip: submit after CDC masterplan approval to avoid re-review", critical: true },
    ...
    fieldNotes: [
      ...
      { text: "Under Prakas No. 291 (2026), a clean construction-permit application runs roughly 65 working days across 8 procedural steps: acknowledgment (2 days), technical/architectural review (20 days), Director-General file review (20 days), permit preparation (5 days), Governor approval (15 days), issuance (2 days), and collection (1 day). A first submission that's missing documents triggers a 20-working-day correction window under Prakas No. 109's inspection-and-certification regime — effectively doubling the timeline. The fee ($3–8/m² of GFA) is set by joint MEF–MLMUPC Prakas and calculated on gross floor area including mezzanines; always get written fee confirmation before submitting, since provincial interpretations vary. A separate Occupancy Certificate is required before the building may be used.", type: "insight" },
      { text: "Soft-title or unregistered land does not block a construction permit application — Article 4 of the permit procedure allows a commune/sangkat certificate confirming the applicant's land-use claim in place of a land title. Confirm this path with the local commune office early if the site's title status isn't fully clean.", type: "tip" },
    ...
    officialSources: [
      ...
      { title: "Prakas No. 291 (2026) — Procedure for Granting & Revoking Construction Permits", org: "Ministry of Land Management (MLMUPC)", url: "https://mlmupc.gov.kh", type: "gov" },
      { title: "Prakas No. 109 — Inspection & Certification of Construction Plans", org: "Ministry of Land Management (MLMUPC)", url: "https://mlmupc.gov.kh", type: "gov" },
    ...
    checklist: [
      ...
      { item: "Prepare the full Art. 4 document set — 5 copies of drawings, inspection/certification report, and drawing-conformity certificate — before submission", critical: true },
      { item: "Ensure architectural and structural drawings are certified under the Prakas No. 109 plan-inspection process before filing the permit application", critical: true },
      ...
      { item: "Confirm the soft-title / commune land-use certificate path early if the site's land title isn't fully registered", critical: false },
      { item: "Apply for the Occupancy Certificate before using the building", critical: true },
  ...
  /* ─── STAGE 06: FACTORY DESIGN ─────────────────────────────── */
  {
    ...
    keyInsight:
      "Roof live load follows IBC: 0.96 kN/m² base, reducible to ~0.50 kN/m² under code-permitted reductions, and down to 0.30 kN/m² only when justified by the PEB supplier per AISC 360 with supporting structural calculations — get the basis of design confirmed in writing before the PEB quote is finalized.",
    processSteps: [
      ...
      { n: 4, title: "Design Development & Specification", desc: "Develop the full design development package: structural calculations (licensed engineer), MEP design (HVAC, electrical, plumbing, fire protection), floor slab specification (thickness, flatness class, joint spacing), roof and cladding specification, loading dock equipment spec, and external works. Critical specs: roof live load per IBC (0.96 kN/m² base, reducible to 0.30–0.50 kN/m² with AISC 360-justified PEB calculations), floor flatness FM2 for logistics (3 mm over 3 m).", duration: "4–6 weeks", risk: "medium" },
    ...
    keyStats: [
      ...
      { value: "0.96 kN/m²", label: "IBC base roof live load", context: "Reducible to ~0.50 kN/m² under code-permitted reductions, or to 0.30 kN/m² only when justified by the PEB supplier per AISC 360 with supporting structural calculations" },
    ...
    checklist: [
      ...
      { item: "Confirm roof live load basis with the PEB supplier (IBC 0.96 kN/m² base; any reduction to 0.30–0.50 kN/m² must be justified per AISC 360 with structural calculations) and 150 mm/hr drainage capacity", critical: true },

...
export const SITES: MapSite[] = [
  // Investment — SEZs & parks
  {
    ...
    notes: "Cambodia's anchor SEZ and the country's leading manufacturing hub. In 2025, PPSEZ recorded exports exceeding USD 2.14 billion (14% growth YoY), employing over 55,000 workers across 114 companies including 85 manufacturers. Key sectors: electronics, automotive wiring, precision components, and garment finishing. Anchor tenants include Minebea Mitsumi, Sumitomo Electric, and YKK.",
  ...
  },
  {
    ...
    score: 92,
    image_url: "https://construction-property.com/wp-content/uploads/2024/04/CPM_SEZ-in-Svay-Reing_-13042024.jpg",
    notes: "Manhattan SVS SEZ is Cambodia's most Vietnam-proximate SEZ at the Bavet/Moc Bai border crossing, hosting 36,000+ workers and attracting Taiwanese electronics, Chinese packaging, and sports apparel tenants (Adidas, PUMA, UNIQLO supply chains). In 2025, zone management partnered with Singapore's SJ Group (Surbana Jurong) to upgrade industrial governance and plan worker housing, schools, and healthcare to reduce labour turnover. Ongoing expansion targeting agriculture, green energy, and logistics sectors.",
  ...
  },
  {
    ...
    status: "Operational",
    score: 88,
    notes: "Tai Seng Bavet SEZ is a Chinese-developed bonded industrial zone within the Bavet cluster, adjacent to Manhattan SVS SEZ. Focuses on light manufacturing, garment, and trade facilitation targeting Vietnam border logistics. Shares the 115kV grid connection from Bavet substation with Manhattan SEZ and Polo Bavet. Chinese developer networks facilitate tenant sourcing from Guangdong/Zhejiang supply chains shifting out of China.",
  ...
  },
  {
    ...
    score: 84,
    notes: "Techo Industrial Park is being developed in Kandal province adjacent to Techo International Airport (opened October 2025). Positioned to capture air-freight logistics, pharmaceutical cold-chain, and high-value electronics manufacturing that benefit from airport proximity. The new cargo terminal (25,000 m² Phase I) at Techo Airport is operational; Phase II adds dedicated freighter apron targeting Q3 2026 commissioning. Utility connections and internal roads under construction.",
  ...
  },
  {
    ...
    status: "Operational",
    score: 81,
    notes: "Polo Bavet Industrial Park is a Thai-developed operational zone within the Bavet SEZ cluster, targeting garment, light assembly, and packaging tenants. Serves as a complementary option to Manhattan SVS SEZ for operators requiring smaller land plots. Benefits from the same NR1 border corridor and bonded logistics infrastructure. The Thai developer pedigree provides credibility with Japanese and Korean buyers auditing Southeast Asia manufacturing bases.",
  ...
  },
  {
    ...
    lng: 104.0960658,
    coordVerified: true,
    size: "600+ ha (full port zone)",
    status: "Under Construction",
    score: 74,
    image_url: "https://thebettercambodia.com/wp-content/uploads/2022/06/Kampot-Port.jpg",
    notes: "The Kampot Logistics & Multipurpose Port (USD 1.5B) is now under construction by Kampot Logistics and Port Firm Ltd on a 600+ hectare site, with Phase 1 targeting 300,000 TEU capacity and ~10,000 jobs. Phase 1 includes container fields, SEZ/free trade zones, logistics centers, customs, and manufacturing units. The deep-sea berths (~15m draft) can accommodate vessels up to 100,000 tonnes. A separate Kampot International Tourism Port was inaugurated in April 2025 for coastal and cross-border cruise traffic. Combined, these projects materially upgrade Kampot's status from 'planned' to active development.",
    strengths: ["New deep-sea port — 15m draft", "SEZ/FTZ integrated within port perimeter", "Low land cost", "Agri-processing proximity"],
    constraints: ["Construction ongoing — commercial ops not yet started", "Limited power infrastructure", "Remote labour pool from Phnom Penh"],
  ...
  },
  {
    ...
    score: 82,
    image_url: "https://construction-property.com/wp-content/uploads/2024/11/CPM_A-large-Industry_11112024.jpg",
    notes: "Kampong Speu SEZ is emerging as Cambodia's fastest-growing industrial province — 92 investment projects were approved in H1 2025 alone, driven by NR4 corridor and expressway access. The Hyundai-Kefico automotive component plant (Phase I) is under construction nearby, signalling an automotive cluster forming. Multiple parallel industrial parks are being developed in the province including a 500 ha green textile industrial park (groundbreaking November 2024) and the Canadia NR51 SEZ (500 ha, approved January 2026), giving Kampong Speu substantial industrial land options across multiple zones.",
    strengths: ["NR4 corridor access", "Expressway interchange", "Competitive land rates", "Labour pool from province", "Automotive cluster forming (Hyundai)"],
    constraints: ["Infrastructure partially complete", "115kV connection pending", "Multiple competing parks in same province"],
  ...
  // New sites — added 2026-07-01 by monthly validation agent
  {
    id: "ksez-textile",
    name: "Golden Integrity Green Textile Industrial Park",
    kind: "park",
    layer: "investment",
    province: "Kampong Speu",
    // Phnom Sruoch district centroid — Nominatim verified 2026-07-01
    lat: 11.388,
    lng: 104.378,
    size: "500 ha",
    status: "Under Construction",
    utilities: "Grid connection planned; on-site water treatment",
    road: "Phnom Sruoch district, south Kampong Speu",
    score: 68,
    image_url: "https://construction-property.com/wp-content/uploads/2024/11/CPM_A-large-Industry_11112024.jpg",
    notes: "Golden Integrity International Investment Group broke ground November 8, 2024 on a 500-hectare green textile industrial park in Chheu Neang village, Taing Sya commune, Phnom Sruoch district, Kampong Speu. Focused on printing, dyeing, and electroplating for garment supply chain. Targets 50,000–60,000 jobs at full capacity. Positioned to serve upstream textile input needs for the broader Kampong Speu garment cluster.",
    strengths: ["500 ha land bank — largest Kampong Speu zone by area", "Textile specialisation — upstream input cluster", "New facility with modern infrastructure"],
    constraints: ["Phnom Sruoch location — further from PP than Samrong Tong zones", "Grid connection and utilities not yet commissioned", "No operational track record — greenfield only"],
    targetIndustries: ["Textile Dyeing & Finishing", "Printing & Packaging", "Garment Supply Chain"],
    recommendation: "Early-mover opportunity for textile upstream producers serving the Kampong Speu garment cluster. Monitor utility commissioning and labour recruitment timelines before committing to large plots.",
  },
  {
    id: "canadia-nr51-sez",
    name: "Canadia National Road 51 SEZ",
    kind: "sez",
    layer: "investment",
    province: "Kampong Speu",
    // Nominatim verified 2026-07-01 — Canadia Industrial Park NR51
    lat: 11.560,
    lng: 104.674,
    size: "500 ha",
    status: "Planned",
    road: "National Road 51, Samrong Tong / Samakki Monichey districts",
    score: 65,
    notes: "Canadia National Road 51 SEZ was approved with USD 260M combined capital in the January 2026 batch of three new SEZ approvals (CDC). Located along NR51 in Samrong Tong and Samakki Monichey districts, Kampong Speu province. Developed under the Canadia Group umbrella. NR51 corridor connects Phnom Penh's southwest industrial belt with the outer metro ring road. Proximity to Ring Road 3 interchange gives access to Phnom Penh labour pool.",
    strengths: ["Ring Road 3 / NR51 corridor access", "Canadia Group developer credibility", "500 ha — large land bank"],
    constraints: ["Planned status — no construction commenced", "NR51 industrial corridor less established than NR4", "Grid connection details not yet confirmed"],
    targetIndustries: ["General Manufacturing", "Light Industry", "Logistics", "Food Processing"],
    recommendation: "Monitor CDC development timeline. NR51 has growing industrial momentum but zone is earlier stage than Kampong Speu SEZ on NR4. Watch utility commissioning progress.",
  },
  // Energy — solar
  {
    id: "solar-kspeu",
...
export const RESEARCH: ResearchBrief[] = [
  ...
  { id: "r10", title: "Cambodia Investment Climate 2026", category: "Sector", pages: 3, abstract: "Cambodia projects 5% GDP growth in 2026, 63% renewable energy share, and internet penetration above 67%. This brief contextualises the macro numbers that matter to foreign investors — and the ones that are overstated." },
  { id: "r11", title: "Greenfield FDI & Investment Trends 2025", category: "Sector", pages: 2, abstract: "Cambodia ranked #1 in the Greenfield FDI Performance Index 2025. This brief breaks down where the $9.2B is going, which sectors are gaining the most, and what the Chinese FDI dominance means for Western investors entering now." },
  { id: "r12", title: "Beyond the Factory: What the Next Generation of Manufacturing Means for Cambodia", category: "Sector", pages: 1, abstract: "Using Roadboss Tire Cambodia's planned ISI SEZ operation as a case reference, this Industrial Insight looks at what a major manufacturing investment requires beyond the factory walls — power, water, logistics, people and local supply chain — and what Cambodia must prepare to move from attracting factories to building industrial clusters." },
];

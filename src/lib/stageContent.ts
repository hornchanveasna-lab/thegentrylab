...
export const STAGE_CONTENT: StageContent[] = [
  ...
  /* ─── STAGE 05: PERMIT NAVIGATION ──────────────────────────── */
  {
    ...
    permits: [
      ...
      { name: "Construction Building Permit", authority: "MLMUPC / Provincial Dept. of Land Management", costMin: 3000, costMax: 25000, weeksMin: 8, weeksMax: 16, notes: "Legal basis: Construction Law 2019 Art. 26; MLMUPC Prakas No. 261 (2026) • Fee: $3–8/m² of GFA for industrial buildings, set by joint MEF–MLMUPC Prakas • Submit: 9 copies of application, land title, CAMUP-stamped architectural + structural drawings, MEP drawings, fire safety plan, BCR/FAR calculations • Review stages: architectural (20 days) → fire (20 days) → structural (20 days) → final issuance (2 days) • Tip: submit after CDC masterplan approval to avoid re-review", critical: true },

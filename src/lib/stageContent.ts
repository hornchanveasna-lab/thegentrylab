...
export const STAGE_CONTENT: StageContent[] = [
  ...
  /* ─── STAGE 05: PERMIT NAVIGATION ──────────────────────────── */
  {
    ...
    processSteps: [
      ...
      {
        n: 5, title: "Construction Building Permit (លិខិតអនុញ្ញាតសាងសង់)",
        desc: "Legal basis: Cambodia Construction Law 2019 (NS/RKM/1119/019) Article 26 — all construction requires prior authorization from the competent authority. Issuing authority: MLMUPC (Ministry of Land Management, Urban Planning and Construction), delegated to Provincial/Capital Department of Land Management. Process per MLMUPC Prakas No. 261 (2026): Step 1 (2 working days) — technical officer checks document completeness; Step 2 (20 working days) — architectural review: zoning compliance, FAR, BCR, setbacks, green space, parking; Step 3 (20 working days) — fire safety compliance review; Step 4 (20 working days) — structural/occupancy review; Step 5–6 (5+5 working days) — structural engineer review and compliance confirmation; Step 7 (15 working days) — inspection report compilation; Step 8 (2 working days) — final signing and permit issuance. Total official review: ~67 working days. Required documents (9 copies): application form, land title certificate, topographic survey, CAMUP-stamped architectural drawings (site plan, floor plan, elevation, section), licensed structural engineer drawings, MEP drawings (electrical, plumbing, fire protection, HVAC), BCR/FAR calculations, parking plan, green space plan. Note: Law on Construction Article 44 requires a separate Occupancy Certificate (វិញ្ញាបនបត្រប្រើប្រាស់សំណង់) before the building may be used.",
        duration: "8–16 weeks", risk: "high",
      },
      {

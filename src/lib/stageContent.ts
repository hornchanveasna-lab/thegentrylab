  ...
  /* ─── STAGE 05: PERMIT NAVIGATION ──────────────────────────── */
  {
    ...
    processSteps: [
      ...
      },
      {
        ...
        desc: "Issued by MLMUPC, approved at Governor level, under Prakas No. 291 (2026). ~65 working days end to end across 8 steps (review → Director-General → Governor → issuance); a deficient dossier adds a 20-day correction cycle. Needs land title (or commune land-use certificate for soft title), designer's licence, drawings, and inspection/certification reports. Occupancy Certificate required before use.",
        duration: "8–16 weeks", risk: "high",
      },
      {
    ...
    permits: [
      ...
      { name: "Construction Building Permit", authority: "MLMUPC / Capital-Provincial Governor", costMin: 3000, costMax: 25000, weeksMin: 8, weeksMax: 16, notes: "Basis: Prakas No. 291 (2026, permit procedure), Prakas No. 109 (plan certification) • Fee: $3–8/m² GFA • Submit: land title/lease, designer's licence, drawings, inspection/certification report • ~65 working days clean; +20 days if deficient • Submit after CDC masterplan approval to avoid re-review", critical: true },
    ...
    fieldNotes: [
      ...
      { text: "Prakas No. 291 (2026): a clean permit application runs ~65 working days; a deficient one adds a 20-day correction cycle. Fee is $3–8/m² GFA — get it in writing, since provincial interpretations vary. Occupancy Certificate needed before the building is used.", type: "insight" },
      { text: "Soft-title land doesn't block a permit — a commune/sangkat land-use certificate can substitute for a land title. Confirm this early if the site's title isn't fully clean.", type: "tip" },
    ...
    checklist: [
      ...
      { item: "Prepare drawings, inspection/certification report, and drawing-conformity certificate before submission (Art. 4)", critical: true },
      { item: "Get plans certified under the Prakas No. 109 inspection process before filing the permit application", critical: true },
      ...
      { item: "If land title isn't fully registered, confirm the commune land-use certificate path early", critical: false },

  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white font-sans">
      <main className="max-w-md mx-auto w-full px-4 pt-6 pb-16">
        ...
        {isLoading && <p className="text-white/30 text-sm">Loading photos…</p>}
        {!isLoading && filtered.length === 0 && <p className="text-white/30 text-sm">No photos yet — add some from a project's Site Diary.</p>}

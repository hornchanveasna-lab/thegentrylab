      ...
      <main className="max-w-md sm:max-w-xl md:max-w-3xl lg:max-w-5xl mx-auto w-full px-4 pt-6 pb-24">
        <div className="flex items-center gap-3 mb-4">
          ...
          <button type="button" onClick={() => setTab("settings")} aria-label={t("projectSettings.title")}
            className={`w-9 h-9 rounded-full flex items-center justify-center transition-colors shrink-0 ${tab === "settings" ? "bg-[#ff5100] text-black" : "bg-white/5 text-white/50 hover:text-white hover:bg-white/10"}`}>

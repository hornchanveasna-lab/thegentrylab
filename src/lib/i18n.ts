...
const T = {
  ...
  kh: {
    ...
    hero: {
      ...
      sub: "៩ ដំណាក់កាល · ទីតាំងជាង ២៦០ · វេទិកាឥតគិតថ្លៃ ដែលបង្កើតពីគម្រោងជាង ៥០០ លានដុល្លារ",
      cta1: "ស្វែងរកផែនទី",
      cta2: "អំពីវេទិកា",
      tags: ["GIDF ៩ ដំណាក់កាល", "ទីតាំង ២៦០+", "ចូលប្រើឥតគិតថ្លៃ", "ទិន្នន័យ CDC · EDC · MPWT"],
    },
    gidf: {
    ...
    mapSection: {
      ...
      desc: "ផែនទីរបស់យើងបង្ហាញទីតាំងឧស្សាហកម្មជាង ២៦០ ផ្លូវអភិវឌ្ឍន៍ ៩ ទិន្នន័យ EDC តំបន់ទឹកជំនន់ និងកម្លាំងពលករ — ឥតគិតថ្លៃ",
      cta: "បើកផែនទី",
      liveBadge: "● ព័ត៌មានផ្ទាល់ · កម្ពុជា",
      layersBadge: "ស្រទាប់ ៨ សកម្ម",
      corridorLabel: "ផ្លូវ ៩ · ទីតាំង ២៦០+",
      launchCta: "បើកផែនទីអន្តរកម្ម →",
      stats: [
        { n: "២៦០+", label: "ទីតាំងឧស្សាហកម្ម" },
        { n: "៩",    label: "ផ្លូវអភិវឌ្ឍន៍" },
        { n: "៨",    label: "ស្រទាប់ទិន្នន័យ" },
    ...
    stageProcess: [
      ...
      "លំដាប់: MoE ECC → MISTI → CDC QIP → MoLVT → ភ្លើង → building permit → EDC → ទឹក → customs. ខុសសើម = ចាប់ផ្ដើមឡើងវិញ",
  ...
  cn: {
    ...
    hero: {
      ...
      h1c: "究竟需要",
      h1d: "做什么？",
      sub: "9个阶段 · 260+个已标注地块 · 基于5亿美元+已交付项目打造的免费平台",
      cta1: "查看地图",
      cta2: "关于平台",
      tags: ["9阶段GIDF", "260+地块", "免费使用", "CDC · EDC · MPWT数据"],
    },
    gidf: {
      eyebrow: "框架体系 · GIDF",
      title1: "GentryLab工业",
    ...
    mapSection: {
      ...
      title1: "每一个SEZ、走廊",
      title2: "与风险区 — 全部上图",
      desc: "我们的互动地图涵盖260+工业地块、9条发展走廊、EDC变电站数据、洪水风险区和劳动力覆盖范围 — 完全免费",
      cta: "打开地图",
      liveBadge: "● 实时情报 · 柬埔寨",
      layersBadge: "8个图层已激活",
      corridorLabel: "9条走廊 · 260+地块",
      launchCta: "启动互动地图 →",
      stats: [
        { n: "260+", label: "工业地块" },
        { n: "9",    label: "发展走廊" },
    ...
    stageProcess: [
      ...
      "顺序：MoE ECC→MISTI→CDC QIP→MoLVT→消防→建筑许可→EDC→水务→海关(SEZ)，顺序错误=重来",
  ...
  fr: {
    ...
    hero: {
      ...
      sub: "9 étapes · 260+ sites cartographiés · Plateforme gratuite issue de 500M$+ de projets livrés",
      cta1: "Explorer la carte",
      cta2: "À propos",
      tags: ["GIDF 9 étapes", "260+ sites", "Accès gratuit", "Données CDC · EDC · MPWT"],
    },
    gidf: {
    ...
    mapSection: {
      ...
      desc: "Notre carte interactive superpose 260+ sites industriels, 9 corridors de développement, les données des sous-stations EDC, les zones inondables et les bassins de main-d'œuvre — le tout gratuitement",
      cta: "Ouvrir la carte",
      liveBadge: "● Intelligence en direct · Cambodge",
      layersBadge: "8 couches actives",
      corridorLabel: "9 corridors · 260+ sites",
      launchCta: "Lancer la carte interactive →",
      stats: [
        { n: "260+", label: "Sites industriels" },
        { n: "9",    label: "Corridors"         },
        { n: "8",    label: "Couches de données"},
    ...
    stageProcess: [
      ...
      "Séquence : ECC MoE → licence MISTI → QIP CDC → MoLVT → pompiers → permis construire → EDC → eau → douanes (ZES). Mauvais ordre = recommencer",
  ...
  kr: {
    ...
    hero: {
      ...
      h1c: "개발하려면",
      h1d: "무엇이 필요한가?",
      sub: "9단계 · 260개 이상 부지 · 5억 달러 이상 프로젝트 기반의 무료 플랫폼",
      cta1: "지도 탐색",
      cta2: "플랫폼 소개",
      tags: ["9단계 GIDF", "260개+ 부지", "무료 이용", "CDC · EDC · MPWT 데이터"],
    },
    gidf: {
      eyebrow: "프레임워크 · GIDF",
      title1: "GentryLab 산업",
    ...
    mapSection: {
      ...
      title1: "모든 SEZ, 개발 축",
      title2: "및 위험 지역 — 지도화",
      desc: "260개 이상의 산업 부지, 9개 개발 축, EDC 변전소 데이터, 홍수 위험 지역, 노동력 현황을 레이어로 제공 — 완전 무료",
      cta: "지도 열기",
      liveBadge: "● 실시간 인텔리전스 · 캄보디아",
      layersBadge: "8개 레이어 활성",
      corridorLabel: "9개 축 · 260개+ 부지",
    ...
    stageProcess: [
      ...
      "순서: MoE ECC → MISTI → CDC QIP → MoLVT → 소방 → 건축 허가 → EDC → 수도 → 세관(SEZ). 순서 오류 = 처음부터",
  ...
  jp: {
    ...
    hero: {
      ...
      h1c: "開発するには",
      h1d: "何が必要か？",
      sub: "9段階 · 260以上の拠点をマッピング · 5億ドル以上の完成プロジェクトで構築した無料プラットフォーム",
      cta1: "地図を探索",
      cta2: "プラットフォーム概要",
      tags: ["9段階GIDF", "260以上の拠点", "無料アクセス", "CDC · EDC · MPWTデータ"],
    },
    gidf: {
    ...
    mapSection: {
      ...
      title1: "すべてのSEZ、回廊",
      title2: "リスクゾーン — 地図化",
      desc: "260以上の工業拠点、9つの開発回廊、EDC変電所データ、洪水リスクゾーン、労働力データをレイヤーで提供 — すべて無料",
      cta: "地図を開く",
      liveBadge: "● ライブインテリジェンス · カンボジア",
      layersBadge: "8レイヤー有効",
      corridorLabel: "9回廊 · 260以上の拠点",
    ...
    stageProcess: [
      ...
      "順序：MoE ECC→MISTI→CDC QIP→MoLVT→消防→建築許可→EDC→水道→税関(SEZ)。順序誤り=やり直し",

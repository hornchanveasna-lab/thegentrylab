  ...
  return useQuery<MapSite[]>({
    ...
    queryFn: async () => {
      ...
      return data.map((r) => ({
        ...
        financier: r.financier ?? undefined,
        tributary: r.tributary ?? undefined,
        avg_annual_mwh: r.avg_annual_mwh ?? undefined,
        eia_registered: r.eia_registered ?? undefined,
        eia_type: r.eia_type ?? undefined,
        eia_company: r.eia_company ?? undefined,

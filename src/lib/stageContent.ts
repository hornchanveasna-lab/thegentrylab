...
export const STAGE_CONTENT: StageContent[] = [
  ...
  /* ─── STAGE 05: PERMIT NAVIGATION ──────────────────────────── */
  {
    ...
    processSteps: [
      ...
      {
        n: 5, title: "Municipal Building Permit",
        desc: "Building permit issued by the relevant municipal or provincial authority (Phnom Penh: City Hall; provincial: provincial department of public works). Requires: architectural drawings (CAMUP-stamped), structural drawings (CAMUP-stamped engineer), site plan, land title, masterplan approval. Fee: $3–8/m² of gross floor area.",
        duration: "4–8 weeks", risk: "medium",
      },
      {
    ...
    permits: [
      ...
      { name: "Municipal Building Permit", authority: "City Hall / Provincial DPWT", costMin: 3000, costMax: 25000, weeksMin: 4, weeksMax: 8, notes: "Fee: $3–8/m² of GFA. Requires CAMUP-stamped architectural and structural drawings. Submit after masterplan approval.", critical: true },
    ...
    timelineChart: [
      ...
      { name: "Building Permit", estimated: 6, actual: 8 },
    ...
    fieldNotes: [
      ...
      { text: "The building permit fee ($3–8/m²) is calculated on gross floor area — including mezzanines and covered loading docks. Always get written fee confirmation from the issuing authority before submitting, as interpretations vary.", type: "insight" },
    ...
    checklist: [
      ...
      { item: "Get written building permit fee confirmation before submission", critical: false },
    ...
    extraChart: {
      ...
      data: [
        ...
        { name: "Building Permit", value: 6, value2: 9 },
